...
const DeliveredParcelReport = () => {
  ...
  const AttendaceData = Object.values(groupByUserId).map((item) => {
    ...
    for (let i = 0; i < AcutalDays; i++) {
      ...
      // const parcelAllotData = numberAlloted?.deliverdParcel;
...
export default DeliveredParcelReport;
