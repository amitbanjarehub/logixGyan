...
const ReportReceivedParcel = () => {
  ...
  console.log("liwAttendance_18_March", liwParcel);
  ...
  const ReceivedParcelData = Object.values(groupByUserId).map((item) => {
    ...
    for (let i = 0; i < item.length; i++) {
      ...
      console.log("attendance9080:", attendance)
    }

    const data = {
      Name: userName,
      MobileNo: userMobile,
      totalParcelReceived: attendance,
    };
  ...
  console.log("ReceivedParcelData:", ReceivedParcelData);
