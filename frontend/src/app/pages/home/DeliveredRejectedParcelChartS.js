...
let total = 0;
let total2 = 0;
let ReceviedParcelPer = 100;
let received_parcelDataC = [];

const DeliveredRejectedParcelChartS = ({ activeChart, branchId }) => {
  ...
  const ReceivedParcelData = Object.values(groupByUserId, groupByUserIdRec).map((item) => {
    ...
    for (let i = 0; i < AcutalDays; i++) {
      ...
      console.log("Parcel_Received:------------>>>", Parcel_Received)
    ...
    console.log("checkData_18_March:", checkData);
...
export default DeliveredRejectedParcelChartS;
