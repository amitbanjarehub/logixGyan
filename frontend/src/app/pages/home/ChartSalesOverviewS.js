...
const ChartSalesOverviewS = ({ data }) => {
    return (
        <ResponsiveContainer height={192} width={370} style={{ margiLeft: "20px" }}>
            <AreaChart data={data} margin={{ top: 0, right: 0, left: 0, bottom: 0 }}>
                ...
                <XAxis tickLine={true} dataKey="date" axisLine={true} />
                <Area
                    type="monotone"
                    // dataKey={"Delivered"}
                    dataKey={"Parcel_Delivered"}
                    stackId="2"
                    strokeWidth={2}
                    fillOpacity={.7}
                    stroke={"#51459E"}
...
export default ChartSalesOverviewS;
